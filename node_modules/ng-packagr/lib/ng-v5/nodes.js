...
const file_cache_1 = require("../file/file-cache");
...
class EntryPointNode extends node_1.Node {
    constructor(url, sourcesFileCache, analysisSourcesFileCache) {
        super(url);
        this.url = url;
        this.sourcesFileCache = sourcesFileCache;
        this.analysisSourcesFileCache = analysisSourcesFileCache;
        this.type = exports.TYPE_NG_ENTRY_POINT;
        this.cache = {
            sourcesFileCache: new file_cache_1.FileCache(),
            analysisSourcesFileCache: new file_cache_1.FileCache(),
